...
execute if predicate mad:gamerule/match_mode/individual/ run tag @s remove MAD_DetectMazeMaker
execute if predicate mad:gamerule/match_mode/team run function mad:system/item/maze_maker/set_player/add_tag_team
tag @p[predicate=mad:system/item/maze_maker/set_player/detect_maze_maker,sort=nearest] add MAD_MazePlayer

## Randomize
scoreboard players set @p[predicate=mad:system/item/maze_maker/set_player/maze_player] RandomizerResult 0
...
scoreboard players operation @p[predicate=mad:system/item/maze_maker/set_player/maze_player] RandomizerResult = #mad RandomizerSeed
scoreboard players operation @p[predicate=mad:system/item/maze_maker/set_player/maze_player] RandomizerResult %= #mad RandomMax
scoreboard players add @p[predicate=mad:system/item/maze_maker/set_player/maze_player] RandomizerResult 1
