...
scoreboard objectives add TimeSinceDeath minecraft.custom:minecraft.time_since_death ['', {translate: '最後に死亡してからの経過時間'}]
...
scoreboard objectives add ExistsTheEndInWorldBorder dummy ['', {translate: '範囲内にエンド大陸が存在するか'}]
#### チーム数 - 勝敗判定用
