...
execute if predicate mad:gamerule/match_mode/individual/ \
  ...
  function mad:system/fall/initialize/random_spawn/individual/ with storage mad: rules.world_size
execute if predicate mad:gamerule/match_mode/team run \
  function mad:system/fall/initialize/random_spawn/team/ with storage mad: rules.world_size
