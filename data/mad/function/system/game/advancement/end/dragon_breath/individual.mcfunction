...
## スコアボード設定
scoreboard players set @s Advancements_End_dragon_breath 1
...
tellraw @s ['',{translate:'chat.type.advancement.goal',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.end.dragon_breath.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.end.dragon_breath.title'},{translate:'advancements.end.dragon_breath.description'}]}]}}]}]}]
