...
## スコアボード設定
scoreboard players set @s Advancements_End_enter_end_gateway 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.end.enter_end_gateway.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.end.enter_end_gateway.title'},{translate:'advancements.end.enter_end_gateway.description'}]}]}}]}]}]
