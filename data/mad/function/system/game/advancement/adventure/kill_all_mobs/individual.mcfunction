...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_kill_all_mobs 1
...
tellraw @s ['',{translate:'chat.type.advancement.challenge',with:[{selector:'@s'},{translate:'[%s]',color:'dark_purple',with:[{translate:'advancements.adventure.kill_all_mobs.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'dark_purple',with:[{translate:'advancements.adventure.kill_all_mobs.title'},{translate:'advancements.adventure.kill_all_mobs.description'}]}]}}]}]}]
