...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_sleep_in_bed 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.adventure.sleep_in_bed.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.adventure.sleep_in_bed.title'},{translate:'advancements.adventure.sleep_in_bed.description'}]}]}}]}]}]
