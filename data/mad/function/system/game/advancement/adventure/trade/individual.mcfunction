...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_trade 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.adventure.trade.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.adventure.trade.title'},{translate:'advancements.adventure.trade.description'}]}]}}]}]}]
