...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_very_very_frightening 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.adventure.very_very_frightening.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.adventure.very_very_frightening.title'},{translate:'advancements.adventure.very_very_frightening.description'}]}]}}]}]}]
