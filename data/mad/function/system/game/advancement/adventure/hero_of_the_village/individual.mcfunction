...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_hero_of_the_village 1
...
tellraw @s ['',{translate:'chat.type.advancement.challenge',with:[{selector:'@s'},{translate:'[%s]',color:'dark_purple',with:[{translate:'advancements.adventure.hero_of_the_village.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'dark_purple',with:[{translate:'advancements.adventure.hero_of_the_village.title'},{translate:'advancements.adventure.hero_of_the_village.description'}]}]}}]}]}]
