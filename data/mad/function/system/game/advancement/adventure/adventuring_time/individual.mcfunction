...
tellraw @s ['',{translate:'chat.type.advancement.challenge',with:[{selector:'@s'},{translate:'[%s]',color:'dark_purple',with:[{translate:'advancements.adventure.adventuring_time.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'dark_purple',with:[{translate:'advancements.adventure.adventuring_time.title'},{translate:'advancements.adventure.adventuring_time.description'}]}]}}]}]}]
