...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_lightning_rod_with_villager_no_fire 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.adventure.lightning_rod_with_villager_no_fire.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.adventure.lightning_rod_with_villager_no_fire.title'},{translate:'advancements.adventure.lightning_rod_with_villager_no_fire.description'}]}]}}]}]}]
