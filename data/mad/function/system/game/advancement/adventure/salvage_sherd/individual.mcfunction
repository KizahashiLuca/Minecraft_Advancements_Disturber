...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_salvage_sherd 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.adventure.salvage_sherd.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.adventure.salvage_sherd.title'},{translate:'advancements.adventure.salvage_sherd.description'}]}]}}]}]}]
