...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_honey_block_slide 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.adventure.honey_block_slide.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.adventure.honey_block_slide.title'},{translate:'advancements.adventure.honey_block_slide.description'}]}]}}]}]}]
