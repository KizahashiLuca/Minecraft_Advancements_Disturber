...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_craft_decorated_pot_using_only_sherds 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.adventure.craft_decorated_pot_using_only_sherds.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.adventure.craft_decorated_pot_using_only_sherds.title'},{translate:'advancements.adventure.craft_decorated_pot_using_only_sherds.description'}]}]}}]}]}]
