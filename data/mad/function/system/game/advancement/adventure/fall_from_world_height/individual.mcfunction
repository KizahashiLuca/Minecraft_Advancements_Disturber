...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_fall_from_world_height 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.adventure.fall_from_world_height.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.adventure.fall_from_world_height.title'},{translate:'advancements.adventure.fall_from_world_height.description'}]}]}}]}]}]
