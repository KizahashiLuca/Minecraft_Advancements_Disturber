...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_trim_with_all_exclusive_armor_patterns 1
...
tellraw @s ['',{translate:'chat.type.advancement.challenge',with:[{selector:'@s'},{translate:'[%s]',color:'dark_purple',with:[{translate:'advancements.adventure.trim_with_all_exclusive_armor_patterns.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'dark_purple',with:[{translate:'advancements.adventure.trim_with_all_exclusive_armor_patterns.title'},{translate:'advancements.adventure.trim_with_all_exclusive_armor_patterns.description'}]}]}}]}]}]
