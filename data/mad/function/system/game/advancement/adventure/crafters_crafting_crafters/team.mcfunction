...
$tellraw @a[predicate=mad:player/team/$(team)] ['',{translate:'chat.type.advancement.task',with:[{text:'$(text)チーム',color:'$(color)',bold:true},{translate:'[%s]',color:'green',with:[{translate:'advancements.adventure.crafters_crafting_crafters.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.adventure.crafters_crafting_crafters.title'},{translate:'advancements.adventure.crafters_crafting_crafters.description'}]}]}}]}]}]
