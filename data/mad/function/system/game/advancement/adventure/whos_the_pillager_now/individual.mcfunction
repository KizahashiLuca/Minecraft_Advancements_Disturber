...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_whos_the_pillager_now 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.adventure.whos_the_pillager_now.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.adventure.whos_the_pillager_now.title'},{translate:'advancements.adventure.whos_the_pillager_now.description'}]}]}}]}]}]
