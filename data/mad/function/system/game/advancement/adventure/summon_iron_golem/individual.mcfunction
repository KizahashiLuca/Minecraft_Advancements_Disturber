...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_summon_iron_golem 1
...
tellraw @s ['',{translate:'chat.type.advancement.goal',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.adventure.summon_iron_golem.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.adventure.summon_iron_golem.title'},{translate:'advancements.adventure.summon_iron_golem.description'}]}]}}]}]}]
