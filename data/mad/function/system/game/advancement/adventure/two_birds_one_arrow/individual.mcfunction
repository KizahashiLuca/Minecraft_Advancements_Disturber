...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_two_birds_one_arrow 1
...
tellraw @s ['',{translate:'chat.type.advancement.challenge',with:[{selector:'@s'},{translate:'[%s]',color:'dark_purple',with:[{translate:'advancements.adventure.two_birds_one_arrow.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'dark_purple',with:[{translate:'advancements.adventure.two_birds_one_arrow.title'},{translate:'advancements.adventure.two_birds_one_arrow.description'}]}]}}]}]}]
