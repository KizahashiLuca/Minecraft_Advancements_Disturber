...
## 進捗達成フラグ
$scoreboard players set @a[predicate=mad:player/team/$(team)] Advancements_Adventure_spear_many_mobs 1
$scoreboard players set #mad_team_$(team) Advancements_Adventure_spear_many_mobs 1
...
## 進捗付与
$advancement grant @a[predicate=mad:player/team/$(team)] only minecraft:adventure/spear_many_mobs
