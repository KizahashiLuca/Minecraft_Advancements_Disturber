...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.adventure.read_power_from_chiseled_bookshelf.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.adventure.read_power_from_chiseled_bookshelf.title'},{translate:'advancements.adventure.read_power_from_chiseled_bookshelf.description'}]}]}}]}]}]
