...
## スコアボード設定
scoreboard players set @s Advancements_Adventure_totem_of_undying 1
...
tellraw @s ['',{translate:'chat.type.advancement.goal',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.adventure.totem_of_undying.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.adventure.totem_of_undying.title'},{translate:'advancements.adventure.totem_of_undying.description'}]}]}}]}]}]
