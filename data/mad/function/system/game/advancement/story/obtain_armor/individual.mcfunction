...
## スコアボード設定
scoreboard players set @s Advancements_Story_obtain_armor 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.story.obtain_armor.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.story.obtain_armor.title'},{translate:'advancements.story.obtain_armor.description'}]}]}}]}]}]
