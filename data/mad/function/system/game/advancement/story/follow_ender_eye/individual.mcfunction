...
## スコアボード設定
scoreboard players set @s Advancements_Story_follow_ender_eye 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.story.follow_ender_eye.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.story.follow_ender_eye.title'},{translate:'advancements.story.follow_ender_eye.description'}]}]}}]}]}]
