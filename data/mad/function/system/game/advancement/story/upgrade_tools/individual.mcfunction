...
## スコアボード設定
scoreboard players set @s Advancements_Story_upgrade_tools 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.story.upgrade_tools.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.story.upgrade_tools.title'},{translate:'advancements.story.upgrade_tools.description'}]}]}}]}]}]
