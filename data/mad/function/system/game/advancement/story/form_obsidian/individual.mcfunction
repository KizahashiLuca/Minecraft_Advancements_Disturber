...
## スコアボード設定
scoreboard players set @s Advancements_Story_form_obsidian 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.story.form_obsidian.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.story.form_obsidian.title'},{translate:'advancements.story.form_obsidian.description'}]}]}}]}]}]
