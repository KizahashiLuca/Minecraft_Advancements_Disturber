...
## スコアボード設定
scoreboard players set @s Advancements_Story_mine_diamond 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.story.mine_diamond.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.story.mine_diamond.title'},{translate:'advancements.story.mine_diamond.description'}]}]}}]}]}]
