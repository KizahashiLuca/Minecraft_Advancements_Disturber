...
## スコアボード設定
scoreboard players set @s Advancements_Story_enter_the_nether 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.story.enter_the_nether.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.story.enter_the_nether.title'},{translate:'advancements.story.enter_the_nether.description'}]}]}}]}]}]
