...
## スコアボード設定
scoreboard players set @s Advancements_Story_shiny_gear 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.story.shiny_gear.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.story.shiny_gear.title'},{translate:'advancements.story.shiny_gear.description'}]}]}}]}]}]
