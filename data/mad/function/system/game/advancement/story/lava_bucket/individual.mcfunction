...
## スコアボード設定
scoreboard players set @s Advancements_Story_lava_bucket 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.story.lava_bucket.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.story.lava_bucket.title'},{translate:'advancements.story.lava_bucket.description'}]}]}}]}]}]
