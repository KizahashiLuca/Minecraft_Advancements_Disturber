...
## スコアボード設定
scoreboard players set @s Advancements_Story_deflect_arrow 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.story.deflect_arrow.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.story.deflect_arrow.title'},{translate:'advancements.story.deflect_arrow.description'}]}]}}]}]}]
