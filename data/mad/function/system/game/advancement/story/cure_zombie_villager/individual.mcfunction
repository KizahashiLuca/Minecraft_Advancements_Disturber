...
## スコアボード設定
scoreboard players set @s Advancements_Story_cure_zombie_villager 1
...
tellraw @s ['',{translate:'chat.type.advancement.goal',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.story.cure_zombie_villager.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.story.cure_zombie_villager.title'},{translate:'advancements.story.cure_zombie_villager.description'}]}]}}]}]}]
