...
## スコアボード設定
scoreboard players set @s Advancements_Story_enchant_item 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.story.enchant_item.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.story.enchant_item.title'},{translate:'advancements.story.enchant_item.description'}]}]}}]}]}]
