...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_tadpole_in_a_bucket 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.husbandry.tadpole_in_a_bucket.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.husbandry.tadpole_in_a_bucket.title'},{translate:'advancements.husbandry.tadpole_in_a_bucket.description'}]}]}}]}]}]
