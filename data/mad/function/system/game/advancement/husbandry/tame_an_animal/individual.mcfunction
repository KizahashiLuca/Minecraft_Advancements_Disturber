...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_tame_an_animal 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.husbandry.tame_an_animal.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.husbandry.tame_an_animal.title'},{translate:'advancements.husbandry.tame_an_animal.description'}]}]}}]}]}]
