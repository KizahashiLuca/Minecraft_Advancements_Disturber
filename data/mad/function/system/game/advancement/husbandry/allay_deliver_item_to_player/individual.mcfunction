...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_allay_deliver_item_to_player 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.husbandry.allay_deliver_item_to_player.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.husbandry.allay_deliver_item_to_player.title'},{translate:'advancements.husbandry.allay_deliver_item_to_player.description'}]}]}}]}]}]
