...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_obtain_sniffer_egg 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.husbandry.obtain_sniffer_egg.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.husbandry.obtain_sniffer_egg.title'},{translate:'advancements.husbandry.obtain_sniffer_egg.description'}]}]}}]}]}]
