...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_kill_axolotl_target 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.husbandry.kill_axolotl_target.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.husbandry.kill_axolotl_target.title'},{translate:'advancements.husbandry.kill_axolotl_target.description'}]}]}}]}]}]
