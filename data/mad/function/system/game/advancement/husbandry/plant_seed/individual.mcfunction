...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_plant_seed 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.husbandry.plant_seed.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.husbandry.plant_seed.title'},{translate:'advancements.husbandry.plant_seed.description'}]}]}}]}]}]
