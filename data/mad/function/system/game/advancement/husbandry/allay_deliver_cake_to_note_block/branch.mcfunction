...
execute if predicate mad:gamerule/match_mode/team \
  ...
  function mad:system/game/advancement/husbandry/allay_deliver_cake_to_note_block/team with storage mad: team.a
execute if predicate mad:gamerule/match_mode/team \
  ...
  function mad:system/game/advancement/husbandry/allay_deliver_cake_to_note_block/team with storage mad: team.b
execute if predicate mad:gamerule/match_mode/team \
  ...
  function mad:system/game/advancement/husbandry/allay_deliver_cake_to_note_block/team with storage mad: team.c
execute if predicate mad:gamerule/match_mode/team \
  ...
  function mad:system/game/advancement/husbandry/allay_deliver_cake_to_note_block/team with storage mad: team.d
