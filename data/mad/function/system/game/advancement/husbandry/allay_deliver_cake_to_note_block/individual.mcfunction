...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_allay_deliver_cake_to_note_block 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.husbandry.allay_deliver_cake_to_note_block.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.husbandry.allay_deliver_cake_to_note_block.title'},{translate:'advancements.husbandry.allay_deliver_cake_to_note_block.description'}]}]}}]}]}]
