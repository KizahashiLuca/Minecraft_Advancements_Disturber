...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_ride_a_boat_with_a_goat 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.husbandry.ride_a_boat_with_a_goat.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.husbandry.ride_a_boat_with_a_goat.title'},{translate:'advancements.husbandry.ride_a_boat_with_a_goat.description'}]}]}}]}]}]
