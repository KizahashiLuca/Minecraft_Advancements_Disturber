...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_bred_all_animals 1
...
tellraw @s ['',{translate:'chat.type.advancement.challenge',with:[{selector:'@s'},{translate:'[%s]',color:'dark_purple',with:[{translate:'advancements.husbandry.breed_all_animals.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'dark_purple',with:[{translate:'advancements.husbandry.breed_all_animals.title'},{translate:'advancements.husbandry.breed_all_animals.description'}]}]}}]}]}]
