...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_fishy_business 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.husbandry.fishy_business.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.husbandry.fishy_business.title'},{translate:'advancements.husbandry.fishy_business.description'}]}]}}]}]}]
