...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.husbandry.safely_harvest_honey.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.husbandry.safely_harvest_honey.title'},{translate:'advancements.husbandry.safely_harvest_honey.description'}]}]}}]}]}]
