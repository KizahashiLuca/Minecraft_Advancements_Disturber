...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_wax_on 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.husbandry.wax_on.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.husbandry.wax_on.title'},{translate:'advancements.husbandry.wax_on.description'}]}]}}]}]}]
