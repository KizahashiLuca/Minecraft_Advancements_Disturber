...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_complete_catalogue 1
...
tellraw @s ['',{translate:'chat.type.advancement.challenge',with:[{selector:'@s'},{translate:'[%s]',color:'dark_purple',with:[{translate:'advancements.husbandry.complete_catalogue.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'dark_purple',with:[{translate:'advancements.husbandry.complete_catalogue.title'},{translate:'advancements.husbandry.complete_catalogue.description'}]}]}}]}]}]
