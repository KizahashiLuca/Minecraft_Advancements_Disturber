...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_silk_touch_nest 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.husbandry.silk_touch_nest.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.husbandry.silk_touch_nest.title'},{translate:'advancements.husbandry.silk_touch_nest.description'}]}]}}]}]}]
