...
## スコアボード設定
scoreboard players set @s Advancements_Husbandry_froglights 1
...
tellraw @s ['',{translate:'chat.type.advancement.challenge',with:[{selector:'@s'},{translate:'[%s]',color:'dark_purple',with:[{translate:'advancements.husbandry.froglights.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'dark_purple',with:[{translate:'advancements.husbandry.froglights.title'},{translate:'advancements.husbandry.froglights.description'}]}]}}]}]}]
