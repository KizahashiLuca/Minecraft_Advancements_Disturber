...
## スコアボード設定
scoreboard players set @s Advancements_Nether_use_lodestone 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.nether.use_lodestone.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.nether.use_lodestone.title'},{translate:'advancements.nether.use_lodestone.description'}]}]}}]}]}]
