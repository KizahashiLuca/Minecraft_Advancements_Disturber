...
## スコアボード設定
scoreboard players set @s Advancements_Nether_distract_piglin 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.nether.distract_piglin.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.nether.distract_piglin.title'},{translate:'advancements.nether.distract_piglin.description'}]}]}}]}]}]
