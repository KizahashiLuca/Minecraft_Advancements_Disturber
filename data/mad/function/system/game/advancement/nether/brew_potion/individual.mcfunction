...
## スコアボード設定
scoreboard players set @s Advancements_Nether_brew_potion 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.nether.brew_potion.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.nether.brew_potion.title'},{translate:'advancements.nether.brew_potion.description'}]}]}}]}]}]
