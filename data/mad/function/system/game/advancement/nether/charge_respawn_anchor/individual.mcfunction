...
## スコアボード設定
scoreboard players set @s Advancements_Nether_charge_respawn_anchor 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.nether.charge_respawn_anchor.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.nether.charge_respawn_anchor.title'},{translate:'advancements.nether.charge_respawn_anchor.description'}]}]}}]}]}]
