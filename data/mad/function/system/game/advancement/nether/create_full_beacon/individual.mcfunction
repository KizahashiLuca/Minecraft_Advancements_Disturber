...
## スコアボード設定
scoreboard players set @s Advancements_Nether_create_full_beacon 1
...
tellraw @s ['',{translate:'chat.type.advancement.goal',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.nether.create_full_beacon.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.nether.create_full_beacon.title'},{translate:'advancements.nether.create_full_beacon.description'}]}]}}]}]}]
