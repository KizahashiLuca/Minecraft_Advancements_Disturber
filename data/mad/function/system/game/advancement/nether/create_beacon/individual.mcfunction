...
## スコアボード設定
scoreboard players set @s Advancements_Nether_create_beacon 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.nether.create_beacon.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.nether.create_beacon.title'},{translate:'advancements.nether.create_beacon.description'}]}]}}]}]}]
