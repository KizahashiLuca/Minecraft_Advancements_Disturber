...
## スコアボード設定
scoreboard players set @s Advancements_Nether_explore_nether 1
...
tellraw @s ['',{translate:'chat.type.advancement.challenge',with:[{selector:'@s'},{translate:'[%s]',color:'dark_purple',with:[{translate:'advancements.nether.explore_nether.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'dark_purple',with:[{translate:'advancements.nether.explore_nether.title'},{translate:'advancements.nether.explore_nether.description'}]}]}}]}]}]
