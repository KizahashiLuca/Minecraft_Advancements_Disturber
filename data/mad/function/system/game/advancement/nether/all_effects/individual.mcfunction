...
## スコアボード設定
scoreboard players set @s Advancements_Nether_all_effects 1
...
tellraw @s ['',{translate:'chat.type.advancement.challenge',with:[{selector:'@s'},{translate:'[%s]',color:'dark_purple',with:[{translate:'advancements.nether.all_effects.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'dark_purple',with:[{translate:'advancements.nether.all_effects.title'},{translate:'advancements.nether.all_effects.description'}]}]}}]}]}]
