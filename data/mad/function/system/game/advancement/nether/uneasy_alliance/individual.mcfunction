...
## スコアボード設定
scoreboard players set @s Advancements_Nether_uneasy_alliance 1
...
tellraw @s ['',{translate:'chat.type.advancement.challenge',with:[{selector:'@s'},{translate:'[%s]',color:'dark_purple',with:[{translate:'advancements.nether.uneasy_alliance.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'dark_purple',with:[{translate:'advancements.nether.uneasy_alliance.title'},{translate:'advancements.nether.uneasy_alliance.description'}]}]}}]}]}]
