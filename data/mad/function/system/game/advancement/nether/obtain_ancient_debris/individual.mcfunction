...
## スコアボード設定
scoreboard players set @s Advancements_Nether_obtain_ancient_debris 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.nether.obtain_ancient_debris.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.nether.obtain_ancient_debris.title'},{translate:'advancements.nether.obtain_ancient_debris.description'}]}]}}]}]}]
