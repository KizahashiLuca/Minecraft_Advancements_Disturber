...
## スコアボード設定
scoreboard players set @s Advancements_Nether_return_to_sender 1
...
tellraw @s ['',{translate:'chat.type.advancement.challenge',with:[{selector:'@s'},{translate:'[%s]',color:'dark_purple',with:[{translate:'advancements.nether.return_to_sender.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'dark_purple',with:[{translate:'advancements.nether.return_to_sender.title'},{translate:'advancements.nether.return_to_sender.description'}]}]}}]}]}]
