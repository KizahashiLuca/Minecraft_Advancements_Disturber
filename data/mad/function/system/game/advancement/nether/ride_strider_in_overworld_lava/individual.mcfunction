...
## スコアボード設定
scoreboard players set @s Advancements_Nether_ride_strider_in_overworld_lava 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.nether.ride_strider_in_overworld_lava.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.nether.ride_strider_in_overworld_lava.title'},{translate:'advancements.nether.ride_strider_in_overworld_lava.description'}]}]}}]}]}]
