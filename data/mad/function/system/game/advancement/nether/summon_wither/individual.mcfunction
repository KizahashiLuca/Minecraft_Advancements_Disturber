...
## スコアボード設定
scoreboard players set @s Advancements_Nether_summon_wither 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.nether.summon_wither.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.nether.summon_wither.title'},{translate:'advancements.nether.summon_wither.description'}]}]}}]}]}]
