...
## スコアボード設定
scoreboard players set @s Advancements_Nether_find_bastion 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.nether.find_bastion.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.nether.find_bastion.title'},{translate:'advancements.nether.find_bastion.description'}]}]}}]}]}]
