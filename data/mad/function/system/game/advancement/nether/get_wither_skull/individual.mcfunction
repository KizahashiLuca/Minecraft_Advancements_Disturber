...
## スコアボード設定
scoreboard players set @s Advancements_Nether_get_wither_skull 1
...
tellraw @s ['',{translate:'chat.type.advancement.task',with:[{selector:'@s'},{translate:'[%s]',color:'green',with:[{translate:'advancements.nether.get_wither_skull.title',hover_event:{action:'show_text',value:[{translate:'%s\n%s',color:'green',with:[{translate:'advancements.nether.get_wither_skull.title'},{translate:'advancements.nether.get_wither_skull.description'}]}]}}]}]}]
