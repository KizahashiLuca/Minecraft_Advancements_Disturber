...
$execute store result storage mad: care_package.$(number).x int 1 run \
  function mad:system/game/care_package/calculate_summon_point/get_random_value/x with storage mad: rules.world_size
...
$execute store result storage mad: care_package.$(number).z int 1 run \
  function mad:system/game/care_package/calculate_summon_point/get_random_value/z with storage mad: rules.world_size
