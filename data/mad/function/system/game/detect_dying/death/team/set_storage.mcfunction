...
execute store result storage mad: death.absolute_y int 1.0 run data get entity @s LastDeathLocation.pos[1] 1.0
execute store result storage mad: death.absolute_z int 1.0 run data get entity @s LastDeathLocation.pos[2] 1.0
