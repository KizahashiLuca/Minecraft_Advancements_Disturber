...
execute if predicate mad:version/1.21/1/release-candidate run scoreboard players set #mad ReleaseCandidateVersion 1
execute if predicate mad:version/1.21/1/release run scoreboard players set #mad ReleaseVersion 1