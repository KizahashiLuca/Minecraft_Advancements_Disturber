...
## テキストディスプレイ召喚
$execute at @e[predicate=mad:marker/respawn_beacon,limit=1] positioned ~ ~1 ~6.45 run function mad:system/setting/team_rules/1/$(phase)/display/

## フェーズ設定
$function mad:phase/setting/team_rules/1/$(phase)
