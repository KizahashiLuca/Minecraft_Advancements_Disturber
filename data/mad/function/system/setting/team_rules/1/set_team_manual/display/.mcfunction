...
execute if predicate mad:gamerule/team_rules/1/set_team_manual/false run execute positioned ~ ~1.00 ~ run function mad:system/setting/team_rules/1/set_team_manual/display/true {color1:'gray',color2:'dark_red',underlined:'true',text:'クリックして変更',background:'-1'}
#### チーム編成ランダム設定
execute if predicate mad:gamerule/team_rules/1/set_team_manual/true run execute positioned ~ ~0.50 ~ run function mad:system/setting/team_rules/1/set_team_manual/display/false {color1:'gray',color2:'dark_green',underlined:'true',text:'クリックして変更',background:'-1'}
