...
execute if predicate mad:gamerule/team_rules/2/see_friendly_invisibles/false run execute positioned ~ ~1.00 ~ run function mad:system/setting/team_rules/2/see_friendly_invisibles/display/true {color1:'gray',color2:'dark_green',underlined:'true',text:'クリックして変更',background:'-1'}
#### 透明化の視認なし
execute if predicate mad:gamerule/team_rules/2/see_friendly_invisibles/true run execute positioned ~ ~0.50 ~ run function mad:system/setting/team_rules/2/see_friendly_invisibles/display/false {color1:'gray',color2:'dark_red',underlined:'true',text:'クリックして変更',background:'-1'}
