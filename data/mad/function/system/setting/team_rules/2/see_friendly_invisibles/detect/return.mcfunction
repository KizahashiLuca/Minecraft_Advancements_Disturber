...
## 透明化の視認変更メッセージ表示
execute if predicate mad:gamerule/team_rules/2/see_friendly_invisibles/true run function mad:message/setting/team_rules/2/see_friendly_invisibles/ {text:'あり',color:'dark_green'}
execute if predicate mad:gamerule/team_rules/2/see_friendly_invisibles/false run function mad:message/setting/team_rules/2/see_friendly_invisibles/ {text:'なし',color:'dark_red'}
