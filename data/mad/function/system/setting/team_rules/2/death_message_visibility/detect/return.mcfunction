...
## 死亡メッセージ変更メッセージ表示
execute if predicate mad:gamerule/team_rules/2/death_message_visibility/true run function mad:message/setting/team_rules/2/death_message_visibility/ {text:'あり',color:'dark_green'}
execute if predicate mad:gamerule/team_rules/2/death_message_visibility/false run function mad:message/setting/team_rules/2/death_message_visibility/ {text:'なし',color:'dark_red'}
