...
execute if predicate mad:gamerule/team_rules/2/death_message_visibility/false run execute positioned ~ ~1.00 ~ run function mad:system/setting/team_rules/2/death_message_visibility/display/true {color1:'gray',color2:'dark_green',underlined:'true',text:'クリックして変更',background:'0'}
#### 死亡メッセージなし
execute if predicate mad:gamerule/team_rules/2/death_message_visibility/true run execute positioned ~ ~0.50 ~ run function mad:system/setting/team_rules/2/death_message_visibility/display/false {color1:'gray',color2:'dark_red',underlined:'true',text:'クリックして変更',background:'0'}
