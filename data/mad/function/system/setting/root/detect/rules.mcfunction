...
## テキストディスプレイ召喚
$execute at @e[predicate=mad:marker/respawn_beacon,limit=1] positioned ~ ~1 ~6.45 run function mad:system/setting/$(phase)$(stem)/root/display/

## フェーズ設定
$function mad:phase/setting/$(phase)$(stem)/root
