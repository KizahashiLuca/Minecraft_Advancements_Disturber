...
execute if predicate mad:gamerule/daylight_cycle/false run execute positioned ~ ~1.00 ~ run function mad:system/setting/other_rules/daylight_cycle/display/true {color1:'gray',color2:'dark_green',underlined:'true',text:'クリックして変更',background:'0'}
#### 昼夜サイクルなし
execute if predicate mad:gamerule/daylight_cycle/true run execute positioned ~ ~0.50 ~ run function mad:system/setting/other_rules/daylight_cycle/display/false {color1:'gray',color2:'dark_red',underlined:'true',text:'クリックして変更',background:'0'}
