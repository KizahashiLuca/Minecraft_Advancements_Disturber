...
execute unless predicate mad:gamerule/difficulty/peaceful run execute positioned ~ ~1.00 ~ run function mad:system/setting/other_rules/difficulty/display/peaceful {color1:'gray',color2:'dark_purple',underlined:'true',text:'クリックして変更',background:'0'}
#### イージー
...
execute unless predicate mad:gamerule/difficulty/easy run execute positioned ~ ~0.75 ~ run function mad:system/setting/other_rules/difficulty/display/easy {color1:'gray',color2:'dark_blue',underlined:'true',text:'クリックして変更',background:'0'}
#### ノーマル
...
execute unless predicate mad:gamerule/difficulty/normal run execute positioned ~ ~0.50 ~ run function mad:system/setting/other_rules/difficulty/display/normal {color1:'gray',color2:'dark_green',underlined:'true',text:'クリックして変更',background:'0'}
#### ハード
...
execute unless predicate mad:gamerule/difficulty/hard run execute positioned ~ ~0.25 ~ run function mad:system/setting/other_rules/difficulty/display/hard {color1:'gray',color2:'dark_red',underlined:'true',text:'クリックして変更',background:'0'}
#### ハードコア
...
execute unless predicate mad:gamerule/difficulty/hardcore run execute positioned ~ ~0.00 ~ run function mad:system/setting/other_rules/difficulty/display/hardcore {color1:'gray',color2:'black',underlined:'true',text:'クリックして変更',background:'0'}
#### 戻る
