...
execute if predicate mad:gamerule/weather_cycle/false run execute positioned ~ ~1.00 ~ run function mad:system/setting/other_rules/weather_cycle/display/true {color1:'gray',color2:'dark_green',underlined:'true',text:'クリックして変更',background:'-1'}
#### 天気サイクルなし
execute if predicate mad:gamerule/weather_cycle/true run execute positioned ~ ~0.50 ~ run function mad:system/setting/other_rules/weather_cycle/display/false {color1:'gray',color2:'dark_red',underlined:'true',text:'クリックして変更',background:'-1'}
