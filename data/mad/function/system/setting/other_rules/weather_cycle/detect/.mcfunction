...
## 天気サイクル変更
$scoreboard players set #mad WeatherCycle $(number)

## テキストディスプレイ召喚
execute at @e[predicate=mad:marker/respawn_beacon,limit=1] positioned ~ ~1 ~6.45 run function mad:system/setting/other_rules/weather_cycle/display/

## フェーズ設定
function mad:phase/setting/other_rules/weather_cycle
