...
summon minecraft:text_display ~ ~-0.3 ~ {text:{translate:'%s秒',with:[{nbt:'rules.care_package_interval',storage:'mad:'}],color:'white'},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.25,1.25,0.1]},background:-16733696,alignment:'center',Rotation:[180.0f, 0.0f],Tags:['MAD_TextDisplay','MAD_TextDisplay_Wait','MAD_TextDisplay_Wait_CheckList']}