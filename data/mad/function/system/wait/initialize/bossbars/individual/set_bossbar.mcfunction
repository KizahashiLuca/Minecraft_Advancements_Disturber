...
## ボスバー設定
$bossbar add minecraft:bossbar_individual_$(number) ['',{translate:'%s - 生存時間 残り %s 秒',with:[{selector:'@s',color:'red',bold:true},{score:{name:'@s',objective:'Second'},color:'green',bold:true}]}]
