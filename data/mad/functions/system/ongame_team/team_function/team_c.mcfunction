...
## Spectate
execute as @a[team=TeamC,scores={Phase=22,Death=2},gamemode=spectator] run spectate @p[team=TeamC,scores={Phase=21,Death=0},gamemode=adventure,sort=nearest] @s
