...
## Summon minecart
execute if score #mad Version matches ..15 at @e[type=minecraft:area_effect_cloud,tag=Minecart] run summon minecraft:chest_minecart ~ 160 ~ {LootTable:"mad:ongame/chest_minecart_team/until_1_15",Invulnerable:1b,Tags:["Minecart"]}
execute if score #mad Version matches 16.. at @e[type=minecraft:area_effect_cloud,tag=Minecart] run summon minecraft:chest_minecart ~ 160 ~ {LootTable:"mad:ongame/chest_minecart_team/since_1_16",Invulnerable:1b,Tags:["Minecart"]}
