...
## Set scoreboard
advancement grant @a[team=TeamB] only minecraft:adventure/ol_besty
...
tellraw @a[team=TeamB] ["",{"translate":"chat.type.advancement.task","with":[{"text":"青チーム","color":"blue","bold":true},{"translate":"[%s]","color":"green","with":[{"translate":"advancements.adventure.ol_besty.title","hoverEvent":{"action":"show_text","value":[{"translate":"%s\n%s","color":"green","with":[{"translate":"advancements.adventure.ol_besty.title"},{"translate":"advancements.adventure.ol_besty.description"}]}]}}]}]}]
