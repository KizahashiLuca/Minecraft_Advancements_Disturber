...
## Set scoreboard
scoreboard players set @a[team=TeamA] AD_Adventure_voluntary_exile 1
...
tellraw @a[team=TeamA] ["",{"translate":"chat.type.advancement.task","with":[{"text":"紫チーム","color":"dark_purple","bold":true},{"translate":"[%s]","color":"green","with":[{"translate":"advancements.adventure.voluntary_exile.title","hoverEvent":{"action":"show_text","value":[{"translate":"%s\n%s","color":"green","with":[{"translate":"advancements.adventure.voluntary_exile.title"},{"translate":"advancements.adventure.voluntary_exile.description"}]}]}}]}]}]
