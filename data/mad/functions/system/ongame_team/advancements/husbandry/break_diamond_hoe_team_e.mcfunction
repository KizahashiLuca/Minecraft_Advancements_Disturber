...
## Set scoreboard
advancement grant @a[team=TeamE] only minecraft:husbandry/break_diamond_hoe
...
tellraw @a[team=TeamE] ["",{"translate":"chat.type.advancement.challenge","with":[{"text":"紫チーム","color":"dark_purple","bold":true},{"translate":"[%s]","color":"dark_purple","with":[{"translate":"advancements.husbandry.break_diamond_hoe.title","hoverEvent":{"action":"show_text","value":[{"translate":"%s\n%s","color":"dark_purple","with":[{"translate":"advancements.husbandry.break_diamond_hoe.title"},{"translate":"advancements.husbandry.break_diamond_hoe.description"}]}]}}]}]}]
