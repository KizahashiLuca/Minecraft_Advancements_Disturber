...
## Set scoreboard
advancement grant @a[team=TeamD] only minecraft:husbandry/break_diamond_hoe
...
tellraw @a[team=TeamD] ["",{"translate":"chat.type.advancement.challenge","with":[{"text":"緑チーム","color":"green","bold":true},{"translate":"[%s]","color":"dark_purple","with":[{"translate":"advancements.husbandry.break_diamond_hoe.title","hoverEvent":{"action":"show_text","value":[{"translate":"%s\n%s","color":"dark_purple","with":[{"translate":"advancements.husbandry.break_diamond_hoe.title"},{"translate":"advancements.husbandry.break_diamond_hoe.description"}]}]}}]}]}]
