...
## Set scoreboard
scoreboard players set @a[team=TeamA] AD_Husbandry_fishy_business 1
...
tellraw @a[team=TeamA] ["",{"translate":"chat.type.advancement.task","with":[{"text":"紫チーム","color":"dark_purple","bold":true},{"translate":"[%s]","color":"green","with":[{"translate":"advancements.husbandry.fishy_business.title","hoverEvent":{"action":"show_text","value":[{"translate":"%s\n%s","color":"green","with":[{"translate":"advancements.husbandry.fishy_business.title"},{"translate":"advancements.husbandry.fishy_business.description"}]}]}}]}]}]
