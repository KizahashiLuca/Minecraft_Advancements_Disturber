...
## Set scoreboard
scoreboard players set @a[team=TeamB] AD_pg_frinedship 1
...
tellraw @a[team=TeamB] ["",{"translate":"chat.type.advancement.challenge","with":[{"text":"青チーム","color":"blue","bold":true},{"translate":"[%s]","color":"dark_purple","with":[{"text":"仲間思い","hoverEvent":{"action":"show_text","value":[{"translate":"%s\n%s","color":"dark_purple","with":[{"text":"仲間思い"},{"text":"味方を復活"}]}]}}]}]}]
