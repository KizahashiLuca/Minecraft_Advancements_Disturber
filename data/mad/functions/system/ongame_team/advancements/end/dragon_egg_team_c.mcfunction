...
## Set scoreboard
scoreboard players set @a[team=TeamC] AD_End_dragon_egg 1
...
tellraw @a[team=TeamC] ["",{"translate":"chat.type.advancement.goal","with":[{"text":"黄チーム","color":"yellow","bold":true},{"translate":"[%s]","color":"green","with":[{"translate":"advancements.end.dragon_egg.title","hoverEvent":{"action":"show_text","value":[{"translate":"%s\n%s","color":"green","with":[{"translate":"advancements.end.dragon_egg.title"},{"translate":"advancements.end.dragon_egg.description"}]}]}}]}]}]
