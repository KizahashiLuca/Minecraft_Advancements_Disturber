...
execute as @a run tellraw @a ["",{"selector":"@s"},{"text":"  TargetOfRespawn  "},{"score":{"name":"@s","objective":"TargetOfRespawn"}}]
execute as @a run tellraw @a ["",{"selector":"@s"},{"text":"  Phase  "},{"score":{"name":"@s","objective":"Phase"}}]
execute as @a run tellraw @a ["",{"selector":"@s"},{"text":"  Death  "},{"score":{"name":"@s","objective":"Death"}}]
execute as @a run tellraw @a ["",{"selector":"@s"},{"text":"  NumRespawnBeacon  "},{"score":{"name":"@s","objective":"NumRespawnBeacon"}}]
execute as @a run tellraw @a ["",{"selector":"@s"},{"text":"  Role  "},{"score":{"name":"@s","objective":"Role"}}]
execute as @a run tellraw @a ["",{"selector":"@s"},{"text":"  NumOfRespawn  "},{"score":{"name":"@s","objective":"NumOfRespawn"}}]
