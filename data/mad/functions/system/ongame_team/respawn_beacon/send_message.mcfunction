...
scoreboard players add @s TargetOfRespawn 1
execute as @a if score @p[scores={NumRespawnBeacon=1..,Role=1}] TargetOfRespawn = @s NumOfRespawn unless score @p[scores={NumRespawnBeacon=1..,Role=1}] NumOfRespawn = @s NumOfRespawn run tellraw @p[scores={NumRespawnBeacon=1..,Role=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"復活","clickEvent":{"action":"run_command","value":"/trigger RespawnTrigger set 2"},"hoverEvent":{"action":"show_text","value":[{"text":"復活"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRespawn 1
execute as @a if score @p[scores={NumRespawnBeacon=1..,Role=1}] TargetOfRespawn = @s NumOfRespawn unless score @p[scores={NumRespawnBeacon=1..,Role=1}] NumOfRespawn = @s NumOfRespawn run tellraw @p[scores={NumRespawnBeacon=1..,Role=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"復活","clickEvent":{"action":"run_command","value":"/trigger RespawnTrigger set 3"},"hoverEvent":{"action":"show_text","value":[{"text":"復活"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRespawn 1
execute as @a if score @p[scores={NumRespawnBeacon=1..,Role=1}] TargetOfRespawn = @s NumOfRespawn unless score @p[scores={NumRespawnBeacon=1..,Role=1}] NumOfRespawn = @s NumOfRespawn run tellraw @p[scores={NumRespawnBeacon=1..,Role=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"復活","clickEvent":{"action":"run_command","value":"/trigger RespawnTrigger set 4"},"hoverEvent":{"action":"show_text","value":[{"text":"復活"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRespawn 1
execute as @a if score @p[scores={NumRespawnBeacon=1..,Role=1}] TargetOfRespawn = @s NumOfRespawn unless score @p[scores={NumRespawnBeacon=1..,Role=1}] NumOfRespawn = @s NumOfRespawn run tellraw @p[scores={NumRespawnBeacon=1..,Role=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"復活","clickEvent":{"action":"run_command","value":"/trigger RespawnTrigger set 5"},"hoverEvent":{"action":"show_text","value":[{"text":"復活"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRespawn 1
execute as @a if score @p[scores={NumRespawnBeacon=1..,Role=1}] TargetOfRespawn = @s NumOfRespawn unless score @p[scores={NumRespawnBeacon=1..,Role=1}] NumOfRespawn = @s NumOfRespawn run tellraw @p[scores={NumRespawnBeacon=1..,Role=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"復活","clickEvent":{"action":"run_command","value":"/trigger RespawnTrigger set 6"},"hoverEvent":{"action":"show_text","value":[{"text":"復活"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRespawn 1
execute as @a if score @p[scores={NumRespawnBeacon=1..,Role=1}] TargetOfRespawn = @s NumOfRespawn unless score @p[scores={NumRespawnBeacon=1..,Role=1}] NumOfRespawn = @s NumOfRespawn run tellraw @p[scores={NumRespawnBeacon=1..,Role=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"復活","clickEvent":{"action":"run_command","value":"/trigger RespawnTrigger set 7"},"hoverEvent":{"action":"show_text","value":[{"text":"復活"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRespawn 1
execute as @a if score @p[scores={NumRespawnBeacon=1..,Role=1}] TargetOfRespawn = @s NumOfRespawn unless score @p[scores={NumRespawnBeacon=1..,Role=1}] NumOfRespawn = @s NumOfRespawn run tellraw @p[scores={NumRespawnBeacon=1..,Role=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"復活","clickEvent":{"action":"run_command","value":"/trigger RespawnTrigger set 8"},"hoverEvent":{"action":"show_text","value":[{"text":"復活"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRespawn 1
execute as @a if score @p[scores={NumRespawnBeacon=1..,Role=1}] TargetOfRespawn = @s NumOfRespawn unless score @p[scores={NumRespawnBeacon=1..,Role=1}] NumOfRespawn = @s NumOfRespawn run tellraw @p[scores={NumRespawnBeacon=1..,Role=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"復活","clickEvent":{"action":"run_command","value":"/trigger RespawnTrigger set 9"},"hoverEvent":{"action":"show_text","value":[{"text":"復活"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRespawn 1
execute as @a if score @p[scores={NumRespawnBeacon=1..,Role=1}] TargetOfRespawn = @s NumOfRespawn unless score @p[scores={NumRespawnBeacon=1..,Role=1}] NumOfRespawn = @s NumOfRespawn run tellraw @p[scores={NumRespawnBeacon=1..,Role=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"復活","clickEvent":{"action":"run_command","value":"/trigger RespawnTrigger set 10"},"hoverEvent":{"action":"show_text","value":[{"text":"復活"}]},"color":"green","bold":true}]
