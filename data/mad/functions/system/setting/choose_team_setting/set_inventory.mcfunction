...
execute if score #mad SetTeamManual matches 1 run replaceitem entity @p[tag=Host] inventory.15 minecraft:jack_o_lantern{display:{Name:'"\\u00A7r\\u00A7fチームメンバー 手動選択"'},HideFlags:39} 1
