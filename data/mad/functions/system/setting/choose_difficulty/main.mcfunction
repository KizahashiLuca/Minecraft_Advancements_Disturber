...
## Detect dropping
scoreboard players set @e[type=minecraft:item,nbt={Item:{id:"minecraft:wooden_sword",tag:{display:{Name:'"\\u00A7r\\u00A7fイージー"'},HideFlags:39}}}] ThrowItem 1
scoreboard players set @e[type=minecraft:item,nbt={Item:{id:"minecraft:stone_sword",tag:{display:{Name:'"\\u00A7r\\u00A7fノーマル"'},HideFlags:39}}}] ThrowItem 1
scoreboard players set @e[type=minecraft:item,nbt={Item:{id:"minecraft:diamond_sword",tag:{display:{Name:'"\\u00A7r\\u00A7fハード"'},HideFlags:39}}}] ThrowItem 1
...
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:21b,id:"minecraft:wooden_sword",tag:{display:{Name:'"\\u00A7r\\u00A7fイージー"'},HideFlags:39}}]}] Select21 0
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:22b,id:"minecraft:stone_sword",tag:{display:{Name:'"\\u00A7r\\u00A7fノーマル"'},HideFlags:39}}]}] Select22 0
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:23b,id:"minecraft:diamond_sword",tag:{display:{Name:'"\\u00A7r\\u00A7fハード"'},HideFlags:39}}]}] Select23 0
...
execute if score #mad Difficulty matches 1 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:12b,id:"minecraft:nether_star",tag:{display:{Name:'"\\u00A7r\\u00A7f選択済"'},HideFlags:39}}]}] Selected 0
execute if score #mad Difficulty matches 2 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:13b,id:"minecraft:nether_star",tag:{display:{Name:'"\\u00A7r\\u00A7f選択済"'},HideFlags:39}}]}] Selected 0
execute if score #mad Difficulty matches 3 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:14b,id:"minecraft:nether_star",tag:{display:{Name:'"\\u00A7r\\u00A7f選択済"'},HideFlags:39}}]}] Selected 0
