...
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:20b,id:"minecraft:emerald",tag:{Tags:["MADsetting","100secs"]}}]}] Select20 0
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:21b,id:"minecraft:emerald",tag:{Tags:["MADsetting","200secs"]}}]}] Select21 0
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:22b,id:"minecraft:emerald",tag:{Tags:["MADsetting","300secs"]}}]}] Select22 0
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:23b,id:"minecraft:emerald",tag:{Tags:["MADsetting","400secs"]}}]}] Select23 0
scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:24b,id:"minecraft:emerald",tag:{Tags:["MADsetting","500secs"]}}]}] Select24 0
...
execute if score #mad AddingTime matches 100 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:11b,id:"minecraft:nether_star",tag:{Tags:["MADsetting","selected"]}}]}] Selected 0
execute if score #mad AddingTime matches 200 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:12b,id:"minecraft:nether_star",tag:{Tags:["MADsetting","selected"]}}]}] Selected 0
execute if score #mad AddingTime matches 300 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:13b,id:"minecraft:nether_star",tag:{Tags:["MADsetting","selected"]}}]}] Selected 0
execute if score #mad AddingTime matches 400 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:14b,id:"minecraft:nether_star",tag:{Tags:["MADsetting","selected"]}}]}] Selected 0
execute if score #mad AddingTime matches 500 run scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:15b,id:"minecraft:nether_star",tag:{Tags:["MADsetting","selected"]}}]}] Selected 0
