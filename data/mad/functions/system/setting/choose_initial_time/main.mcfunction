...
execute if score #mad TimeLimit matches 1.. run scoreboard players set @p[tag=Host] Select34 1

scoreboard players set @p[tag=Host,nbt={Inventory:[{Slot:13b,id:"minecraft:clock",tag:{Tags:["MADsetting","choose_initial_time"]}}]}] Select13 0
...
execute as @p[tag=Host,scores={Select13=1}] run function mad:system/setting/choose_initial_time/change_to
execute as @p[tag=Host,scores={Select21=1}] run function mad:system/setting/choose_initial_time/select_digit_0100
execute as @p[tag=Host,scores={Select22=1}] run function mad:system/setting/choose_initial_time/select_digit_0010
execute as @p[tag=Host,scores={Select23=1}] run function mad:system/setting/choose_initial_time/select_digit_0001
execute as @p[tag=Host,scores={Select28=1}] run function mad:system/setting/choose_initial_time/select_cancel
execute as @p[tag=Host,scores={Select31=1}] run function mad:system/setting/choose_initial_time/select_reset
