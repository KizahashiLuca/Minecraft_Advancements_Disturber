...
execute as @p[tag=Host,scores={Select21=1}] run function mad:system/setting/choose_initial_time/select_digit_100
execute as @p[tag=Host,scores={Select22=1}] run function mad:system/setting/choose_initial_time/select_digit_010
execute as @p[tag=Host,scores={Select23=1}] run function mad:system/setting/choose_initial_time/select_digit_001
