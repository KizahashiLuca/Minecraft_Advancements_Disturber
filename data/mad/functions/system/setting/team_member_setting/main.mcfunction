...
execute as @p[tag=Host,scores={Select20=1}] run function mad:system/setting/team_member_setting/set_own_team_a
execute as @p[tag=Host,scores={Select21=1}] run function mad:system/setting/team_member_setting/set_own_team_b
execute as @p[tag=Host,scores={Select22=1}] run function mad:system/setting/team_member_setting/set_own_team_c
execute as @p[tag=Host,scores={Select23=1}] run function mad:system/setting/team_member_setting/set_own_team_d
execute as @p[tag=Host,scores={Select24=1}] run function mad:system/setting/team_member_setting/set_own_team_e
