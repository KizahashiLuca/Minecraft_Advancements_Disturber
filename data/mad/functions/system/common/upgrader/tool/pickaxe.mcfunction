...
data modify entity @e[predicate=mad:system/common/upgrader/tool/pickaxe,sort=nearest,limit=1] Item.tag set from entity @s[predicate=mad:system/common/upgrader/tool/offhand] Inventory[{Slot:-106b}].tag
