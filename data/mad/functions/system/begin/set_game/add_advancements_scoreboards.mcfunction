...
scoreboard objectives add AD_Originals_find_trial_chamber dummy
...
scoreboard objectives add AD_Originals_kill_breeze dummy
...
scoreboard objectives add AD_Originals_obtain_armadillo_scute dummy
...
scoreboard objectives add AD_Originals_obtain_trial_key dummy
