...
scoreboard objectives add SidebarA dummy ["",{"text":"設定項目A"}]
scoreboard objectives add SidebarB dummy ["",{"text":"設定項目B"}]
scoreboard objectives add SidebarC dummy ["",{"text":"設定項目C"}]
scoreboard objectives add SidebarD dummy ["",{"text":"設定項目D"}]
scoreboard objectives add SidebarE dummy ["",{"text":"設定項目E"}]
#### timer
...
scoreboard objectives add MazeNumber dummy
scoreboard objectives add MazeNumberTmp dummy
scoreboard objectives add MazePosX dummy
scoreboard objectives add MazePosZ dummy
scoreboard objectives add DeadEnd dummy
scoreboard objectives add HasExit dummy
#### teleport arrow
