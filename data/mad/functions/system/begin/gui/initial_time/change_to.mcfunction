...
## Set scoreboard
scoreboard players operation #mad Digit0100 = #mad TimeLimit
scoreboard players operation #mad Digit0100 /= #mad 100
scoreboard players operation #mad Digit0010 = #mad TimeLimit
scoreboard players operation #mad Digit0010 %= #mad 100
scoreboard players operation #mad Digit0010 /= #mad 10
scoreboard players operation #mad Digit0001 = #mad TimeLimit
scoreboard players operation #mad Digit0001 %= #mad 100
scoreboard players operation #mad Digit0001 %= #mad 10

## Replace inventory
loot replace entity @p[predicate=mad:player/host] inventory.4 loot mad:system/begin/gui/root/initial_time
...
loot replace entity @p[predicate=mad:player/host,predicate=mad:system/begin/gui/initial_time/gt_zero] inventory.25 loot mad:system/begin/gui/initial_time/ok
