...
loot replace entity @p[predicate=mad:player/host] inventory.10 loot mad:system/begin/gui/team_match/team_member_select
loot replace entity @p[predicate=mad:player/host] inventory.11 loot mad:system/begin/gui/team_match/number_of_teams
loot replace entity @p[predicate=mad:player/host] inventory.12 loot mad:system/begin/gui/team_match/number_of_respawn_beacons
loot replace entity @p[predicate=mad:player/host] inventory.13 loot mad:system/begin/gui/team_match/respawn_banner_time
...
loot replace entity @p[predicate=mad:player/host] inventory.16 loot mad:system/begin/gui/team_match/other_rules
