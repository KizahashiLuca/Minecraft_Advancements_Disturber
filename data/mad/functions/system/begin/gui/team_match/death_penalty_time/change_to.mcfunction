...
loot replace entity @p[predicate=mad:player/host,predicate=mad:system/begin/gui/team_match/death_penalty_time/gt_zero] inventory.25 loot mad:system/begin/gui/team_match/death_penalty_time/ok
