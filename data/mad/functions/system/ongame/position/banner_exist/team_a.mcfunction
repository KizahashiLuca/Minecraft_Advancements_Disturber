...
## Scoreboard
execute store result score @s BannerPosX run data get entity @e[type=minecraft:armor_stand,tag=RespawnBanner,team=TeamA,sort=nearest,limit=1] Pos[0] 1
execute store result score @s BannerPosY run data get entity @e[type=minecraft:armor_stand,tag=RespawnBanner,team=TeamA,sort=nearest,limit=1] Pos[1] 1
execute store result score @s BannerPosZ run data get entity @e[type=minecraft:armor_stand,tag=RespawnBanner,team=TeamA,sort=nearest,limit=1] Pos[2] 1
