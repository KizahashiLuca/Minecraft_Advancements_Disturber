...
## Detect armor stand
execute if entity @e[type=minecraft:armor_stand,tag=RespawnBanner,team=TeamD] run function mad:system/ongame/position/banner_exist/team_d
execute unless entity @e[type=minecraft:armor_stand,tag=RespawnBanner,team=TeamD] run title @s actionbar ["",{"text":"現在の座標 : ( ","color":"light_purple"},{"score": {"name":"@s","objective": "PosX"},"color":"light_purple"},{"text":", ","color":"light_purple"},{"score": {"name":"@s","objective": "PosY"},"color":"light_purple"},{"text":", ","color":"light_purple"},{"score": {"name":"@s","objective": "PosZ"},"color":"light_purple"},{"text":")","color":"light_purple"}]