...
execute if predicate mad:system/item/maze_maker/maze_size/5x5 if predicate mad:system/item/maze_maker/detect_path/1m/east run scoreboard players set @s[predicate=mad:system/item/maze_maker/answer/east,scores={MazePosZ=..3}] RandomAngle 4
execute if predicate mad:system/item/maze_maker/maze_size/7x7 if predicate mad:system/item/maze_maker/detect_path/1m/east run scoreboard players set @s[predicate=mad:system/item/maze_maker/answer/east,scores={MazePosZ=..5}] RandomAngle 4
execute if predicate mad:system/item/maze_maker/maze_size/9x9 if predicate mad:system/item/maze_maker/detect_path/1m/east run scoreboard players set @s[predicate=mad:system/item/maze_maker/answer/east,scores={MazePosZ=..7}] RandomAngle 4
execute if predicate mad:system/item/maze_maker/maze_size/11x11 if predicate mad:system/item/maze_maker/detect_path/1m/east run scoreboard players set @s[predicate=mad:system/item/maze_maker/answer/east,scores={MazePosZ=..9}] RandomAngle 4
execute if predicate mad:system/item/maze_maker/maze_size/13x13 if predicate mad:system/item/maze_maker/detect_path/1m/east run scoreboard players set @s[predicate=mad:system/item/maze_maker/answer/east,scores={MazePosZ=..11}] RandomAngle 4
execute if predicate mad:system/item/maze_maker/maze_size/15x15 if predicate mad:system/item/maze_maker/detect_path/1m/east run scoreboard players set @s[predicate=mad:system/item/maze_maker/answer/east,scores={MazePosZ=..13}] RandomAngle 4
execute if predicate mad:system/item/maze_maker/maze_size/17x17 if predicate mad:system/item/maze_maker/detect_path/1m/east run scoreboard players set @s[predicate=mad:system/item/maze_maker/answer/east,scores={MazePosZ=..15}] RandomAngle 4
execute if predicate mad:system/item/maze_maker/maze_size/19x19 if predicate mad:system/item/maze_maker/detect_path/1m/east run scoreboard players set @s[predicate=mad:system/item/maze_maker/answer/east,scores={MazePosZ=..17}] RandomAngle 4