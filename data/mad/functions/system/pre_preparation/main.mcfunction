...
execute if score #mad Second matches 20 if score #mad Tick matches 0 if score #mad IsTeam matches 1 as @e[type=minecraft:armor_stand,tag=RespawnBeaconPosition,limit=1] at @s run function mad:system/ongame/respawn_beacon/construct_respawn_beacon
execute if score #mad Second matches 19 if score #mad Tick matches 0 if score #mad IsTeam matches 1 as @e[type=minecraft:armor_stand,tag=RespawnBeaconPosition,limit=1] at @s run function mad:system/ongame/respawn_beacon/construct_respawn_beacon
execute if score #mad Second matches 18 if score #mad Tick matches 0 if score #mad IsTeam matches 1 as @e[type=minecraft:armor_stand,tag=RespawnBeaconPosition,limit=1] at @s run function mad:system/ongame/respawn_beacon/construct_respawn_beacon
execute if score #mad Second matches 17 if score #mad Tick matches 0 if score #mad IsTeam matches 1 as @e[type=minecraft:armor_stand,tag=RespawnBeaconPosition,limit=1] at @s run function mad:system/ongame/respawn_beacon/construct_respawn_beacon
execute if score #mad Second matches 16 if score #mad Tick matches 0 if score #mad IsTeam matches 1 as @e[type=minecraft:armor_stand,tag=RespawnBeaconPosition,limit=1] at @s run function mad:system/ongame/respawn_beacon/construct_respawn_beacon
