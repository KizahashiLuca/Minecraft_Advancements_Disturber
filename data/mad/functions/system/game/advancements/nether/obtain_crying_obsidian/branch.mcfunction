...
execute if predicate mad:gamerules/match_mode/team if score #mad_team_e AD_Nether_obtain_crying_obsidian matches 0 as @s[predicate=mad:player/team/e] run function mad:system/game/advancements/nether/obtain_crying_obsidian/team/e
