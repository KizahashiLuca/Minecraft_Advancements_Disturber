...
execute if predicate mad:gamerules/match_mode/team if score #mad_team_e AD_End_respawn_dragon matches 0 as @s[predicate=mad:player/team/e] run function mad:system/game/advancements/end/respawn_dragon/team/e
