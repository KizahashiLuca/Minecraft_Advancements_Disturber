...
execute if predicate mad:gamerules/match_mode/team if score #mad_team_e AD_Husbandry_complete_catalogue matches 0 as @s[predicate=mad:player/team/e] run function mad:system/game/advancements/husbandry/complete_catalogue/team/e
