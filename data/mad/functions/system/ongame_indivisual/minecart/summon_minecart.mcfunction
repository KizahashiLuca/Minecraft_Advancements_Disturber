...
## Summon minecart
execute if score #mad Version matches ..15 at @e[type=minecraft:area_effect_cloud,tag=Minecart] run summon minecraft:chest_minecart ~ 160 ~ {LootTable:"mad:chest_minecart_14_indivisual",Invulnerable:1b,Tags:["Minecart"]}
execute if score #mad Version matches 16.. at @e[type=minecraft:area_effect_cloud,tag=Minecart] run summon minecraft:chest_minecart ~ 160 ~ {LootTable:"mad:chest_minecart_16_indivisual",Invulnerable:1b,Tags:["Minecart"]}
