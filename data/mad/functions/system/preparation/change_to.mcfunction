...
## Teleport
execute if score #mad IsTeam matches 0 at @e[predicate=mad:marker/world_spawn,limit=1] run function mad:system/preparation/random_teleport_individual
execute if score #mad IsTeam matches 1 at @e[predicate=mad:marker/world_spawn,limit=1] run function mad:system/preparation/random_teleport_team
execute as @a[tag=Participant] at @s run tp @s ~ 320 ~
