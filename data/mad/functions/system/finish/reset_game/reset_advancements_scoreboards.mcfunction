...
scoreboard objectives remove AD_Originals_find_trial_chamber
...
scoreboard objectives remove AD_Originals_kill_breeze
...
scoreboard objectives remove AD_Originals_obtain_armadillo_scute
...
scoreboard objectives remove AD_Originals_obtain_trial_key
